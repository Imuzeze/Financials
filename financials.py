...
st.markdown("<h4 style = 'margin: -30px; color: #A0153E; text-align: center; font-family: italic'>BUILT BY JOSHUA </h4>", unsafe_allow_html = True)
...
# #add image
st.image('pngwing.com (2).png',width = 600)
